...
st.image('mouse_lemur_muscles_small.jpg', caption='Musculoskeletal model of the mouse lemur. The muscles are represented by a series of strands, whose colours corresponding to the different muscle groupes.')
